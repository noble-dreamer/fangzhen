...
- `D:\lab_ultr\fz\simple\f_domain\new\output_dataset\dataset_a_frequency_shell\pipe_shell_frequency_irregular_sample_0001.mph`
- `D:\lab_ultr\fz\simple\f_domain\new\output_dataset\dataset_a_frequency_shell\defect_tables\irregular_sample_0001.txt`
- `D:\lab_ultr\fz\simple\f_domain\new\output_dataset\dataset_a_frequency_shell\metadata\pipe_shell_frequency_irregular_sample_0001.json`
...
```json
{
  "pipe_shell_frequency_irregular_sample_0001": []
}
```
